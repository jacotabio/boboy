  ...
  <div class="container-fluid no-gap">
    <div class="row">
      <div class="col-xs-8 col-lg-8">
        <a href="/sng/?mod=profile&t=orders" class="btn btn-action"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;&nbsp;Back</a>
      </div>
      <?php 
      if($st == 0){
      ?>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-xs-9 col-sm-3 col-lg-3" style="margin-top:16px;">
          ...
          <p class="no-gap" style="font-size: 13px;"><?php $date = new DateTime($oinfo['created_at']); echo $date->format("M d, Y g:mA");?></p>
        </div>
        <div class="col-xs-12 col-sm-7 col-lg-7" style="margin-top:16px;">
          ...
          <p class="no-gap" style="font-size: 13px;">Clayton Street, St. Francis Village, Taculing</p>
        </div>
      </div>
    </div>
