...
function ohistory_show(){
	document.getElementById('ohistory-modal').style.display = "inline-block";
}
...
document.getElementById('popup-modal-2').style.display = "inline-block";
}
...
c_id = cid;
document.getElementById('cart-modal').style.display = "inline-block";
...
document.getElementById('cart-removeall-modal').style.display = "inline-block";
}
