			...
			<div id="cart-content">
				<table id="cart-table">
					<tr class="cart-head">
						...
						<th class="ta-center">Quantity</th>
						<th class="ta-center product-link" style="color: red;" onclick="pop_cart_removeall_show()">Remove All</th>
					</tr>
					<?php
					...
					?>
						<tr class="cart-tr">
							...
							<td class="ta-center"><?php echo $stocks;?></td>
				...
				<div id="cart-summary">
					...
					<table id="cart-summary-table">
						<tr>
							<td>Total Items: </td>
							<td class="ta-right"><?php echo $product->count_cart($_SESSION['c_userid']);?> items</td>
						</tr>	
						<tr>
							<td>Subtotal</td>
				...
				<!-- <a id="btn-cart-removeall" class="button-classic" onclick="pop_cart_removeall_show()">Remove All</a> -->
	...
	<?php
		...
		<div id="cart-ads-wrapper">
			<div id="cart-ads-content">
				<h5>Some awesome title over here</h5>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam dapibus dignissim velit, vitae bibendum sapien mollis eget. Donec fermentum turpis sem, eu tempus leo viverra in. Quisque eu justo et quam suscipit commodo vel at erat. Phasellus fringilla pretium justo id varius. Maecenas tincidunt ullamcorper ultrices. Aenean nec tempor augue, eu lacinia purus. </p>
			</div>
			<div id="cart-ads-content">
				<h5>Some awesome title over here</h5>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam dapibus dignissim velit, vitae bibendum sapien mollis eget. Donec fermentum turpis sem, eu tempus leo viverra in. Quisque eu justo et quam suscipit commodo vel at erat. Phasellus fringilla pretium justo id varius. Maecenas tincidunt ullamcorper ultrices. Aenean nec tempor augue, eu lacinia purus. </p>
			...
			<div id="cart-ads-content">
				<h5>Some awesome title over here</h5>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam dapibus dignissim velit, vitae bibendum sapien mollis eget. Donec fermentum turpis sem, eu tempus leo viverra in. Quisque eu justo et quam suscipit commodo vel at erat. Phasellus fringilla pretium justo id varius. Maecenas tincidunt ullamcorper ultrices. Aenean nec tempor ajakjhakjahkjahaugue, eu lacinia purus. </p>
			</div>
		</div>
	<?php
		}
